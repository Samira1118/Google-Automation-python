...
def load_data(filename):
  ...
  with open(filename) as json_file:
    ...
    data = stored(new_data, key=lambda i: i['total_sales'])
  return data
...
def main(argv):
  ...
  data = load_data("/home/student-01-b81168019f12/car_sales.json")
  ...
  msg = email_generate ("automation@example.com","student-01-b81168019f12@example.com","Sales summary for last month",new_summary,"/tmp/cars.pdf")
